...
GUI:AddOptions(function(self)
	...
	Left:CreateButton(Language["Search"], Language["Find Cheapest Item"], Language["Find the cheapest item currently in your inventory"], PrintCheapest)
	Left:CreateButton(Language["Delete"], Language["Delete Cheapest Item"], Language["Delete the cheapest item currently in your inventory"], DeleteCheapest)
	Left:CreateSwitch("delete-filter-consumable", Settings["delete-filter-consumable"], Language["Filter Consumables"], Language["Exclude consumables"], UpdateDeleteFilterConsumable)
	Left:CreateSwitch("delete-filter-container", Settings["delete-filter-container"], Language["Filter Containers"], Language["Exclude container items"], UpdateFilterContainer)
	Left:CreateSwitch("delete-filter-weapon", Settings["delete-filter-weapon"], Language["Filter Weapons"], Language["Exclude weapons items"], UpdateFilterWeapon)
	Left:CreateSwitch("delete-filter-armor", Settings["delete-filter-armor"], Language["Filter Armor"], Language["Exclude armor items"], UpdateFilterArmor)
	Left:CreateSwitch("delete-filter-reagent", Settings["delete-filter-reagent"], Language["Filter Reagents"], Language["Exclude reagent related items"], UpdateFilterReagent)
	Left:CreateSwitch("delete-filter-tradeskill", Settings["delete-filter-tradeskill"], Language["Filter Tradeskills"], Language["Exclude tradeskill related items"], UpdateFilterTradeskill)
	Left:CreateSwitch("delete-filter-quest", Settings["delete-filter-quest"], Language["Filter Quest Items"], Language["Exclude quest related items"], UpdateFilterQuest)
