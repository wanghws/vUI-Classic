...
--[[GUI.Widgets.CreateHeader = function(self, text)
	...
	Header.Text:SetFontInfo(Settings["ui-widget-font"], 12)
...
GUI.Widgets.CreateHeader = function(self, text)
	...
	Anchor.Text:SetFontInfo(Settings["ui-header-font"], 12) -- 14
...
GUI.Widgets.CreateButton = function(self, value, label, tooltip, hook)
	...
	Button.MiddleText:SetFontInfo(Settings["ui-widget-font"], 12)
	...
	Button.Text:SetFontInfo(Settings["ui-widget-font"], 12)
...
GUI.Widgets.CreateStatusBar = function(self, value, minvalue, maxvalue, label, tooltip, hook)
	...
	Bar.MiddleText:SetFontInfo(Settings["ui-widget-font"], 12)
	...
	Bar.Text:SetFontInfo(Settings["ui-widget-font"], 12)
...
GUI.Widgets.CreateCheckbox = function(self, id, value, label, tooltip, hook)
	...
	Checkbox.Text:SetFontInfo(Settings["ui-widget-font"], 12)
...
GUI.Widgets.CreateSwitch = function(self, id, value, label, tooltip, hook)
	...
	Switch.Text:SetFontInfo(Settings["ui-widget-font"], 12)
...
GUI.Widgets.CreateInput = function(self, id, value, label, tooltip, hook)
	...
	Input.Box:SetFontInfo(Settings["ui-widget-font"], 12)
	...
	Input.Text:SetFontInfo(Settings["ui-widget-font"], 12)
...
GUI.CreateExportWindow = function(self)
	...
	Window.Header.Text:SetFontInfo(Settings["ui-header-font"], 14)
	...
	Window.Input:SetFontInfo(Settings["ui-widget-font"], 12)
...
GUI.Widgets.CreateDropdown = function(self, id, value, values, label, tooltip, hook, specific)
	...
	Dropdown.Current:SetFontInfo(Settings["ui-widget-font"], 12)
	...
	Dropdown.Text:SetFontInfo(Settings["ui-widget-font"], 12)
	...
	elseif (specific == "Font") then
		...
		Dropdown.Current:SetFontInfo(Settings[id], 12)
	else
		Dropdown.Texture:SetTexture(Media:GetTexture(Settings["ui-widget-texture"]))
	end
...
GUI.Widgets.CreateSlider = function(self, id, value, minvalue, maxvalue, step, label, tooltip, hook, prefix, postfix)
	...
	EditBox.Box:SetFontInfo(Settings["ui-widget-font"], 12)
	...
	Slider.Text:SetFontInfo(Settings["ui-widget-font"], 12)
...
local CreateColorPicker = function()
	...
	ColorPicker.Header.Text:SetFontInfo(Settings["ui-header-font"], 14)
	...
	ColorPicker.CurrentText:SetFontInfo(Settings["ui-header-font"], 12)
	...
	ColorPicker.CurrentHexText:SetFontInfo(Settings["ui-header-font"], 12)
	...
	ColorPicker.NewText:SetFontInfo(Settings["ui-header-font"], 12)
	...
	ColorPicker.NewHexText:SetFontInfo(Settings["ui-wudget-font"], 12)
	...
	ColorPicker.AcceptText:SetFontInfo(Settings["ui-button-font"], 12)
	...
	ColorPicker.CancelText:SetFontInfo(Settings["ui-button-font"], 12)
...
GUI.CreateWindow = function(self, name, default)
	...
	Button.Text:SetFontInfo(Settings["ui-widget-font"], 14)
