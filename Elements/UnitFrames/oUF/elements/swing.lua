...
local function Melee(self, event)
	local _, subevent, hidecaster, GUID = CombatLogGetCurrentEventInfo()
...
local function ParryHaste(self, event)
	local _, subevent, hidecaster, GUID, _, _, _, tarGUID, _,_,_, missType = CombatLogGetCurrentEventInfo()
