...
GUI:AddOptions(function(self)
	...
	Left:CreateCheckbox("experience-enable", true, Language["Enable Experience Module"], "Enable the vUI experience module"):RequiresReload(true)
	
	Left:CreateHeader(Language["Styling"])
	Left:CreateCheckbox("experience-display-level", Settings["experience-display-level"], Language["Display Level"], "Display your current level in the experience bar", UpdateDisplayLevel)
	Left:CreateCheckbox("experience-display-progress", Settings["experience-display-progress"], Language["Display Progress Text"], "Display your current progress|ninformation in the experience bar", UpdateDisplayProgress)
	Left:CreateCheckbox("experience-display-percent", Settings["experience-display-percent"], Language["Display Percent Text"], "Display your current percent|ninformation in the experience bar", UpdateDisplayPercent)
	Left:CreateCheckbox("experience-show-tooltip", Settings["experience-show-tooltip"], Language["Display Tooltip"], "Display a tooltip when mousing over the experience bar")
	Left:CreateCheckbox("experience-animate", Settings["experience-animate"], Language["Animate Experience Changes"], "Smoothly animate changes to the experience bar")
