...
Popup.CreatePopupFrame = function(self)
	...
	self.Body.Text:SetFont(Media:GetFont(Settings["ui-button-font"]), 12)
	...
	self.Button1.Text:SetFont(Media:GetFont(Settings["ui-button-font"]), 12)
	...
	self.Button2.Text:SetFont(Media:GetFont(Settings["ui-button-font"]), 12)
